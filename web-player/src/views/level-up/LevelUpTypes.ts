...
interface AutoLevel {
  ...
  slots: number[] | null;
  features: { id?: string; name: string; text: string; optional: boolean; subclass?: string | null; effects?: unknown[]; noteTemplate?: { id: string; title: string; text: string } | null; choices?: import("@/views/character-creator/utils/CharacterCreatorClassCoreUtils").CreatorFeatureLike["choices"]; talent?: import("@/views/character-creator/utils/CharacterCreatorClassCoreUtils").CreatorFeatureLike["talent"]; preparedSpellProgression?: PreparedSpellProgressionTable[]; hidden?: boolean }[];
