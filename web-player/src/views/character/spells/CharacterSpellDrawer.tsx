...
import type { FetchedSpellDetail } from "@/views/character/spells/CharacterSpellShared";
import { DMG_COLORS, DMG_EMOJI, getScaledSpellDamage } from "@/views/character/spells/CharacterSpellShared";
