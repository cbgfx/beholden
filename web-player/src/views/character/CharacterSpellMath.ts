...
export interface FetchedSpellDetailLike {
  name: string;
  level: number | null;
  school?: string | null;
  time?: string | null;
...
export function getScaledSpellDamage(detail: FetchedSpellDetailLike, charLevel: number, maxSlotLevel: number): { dice: string; type: string } | null {
...
export function abbrevTime(t: string): string {
