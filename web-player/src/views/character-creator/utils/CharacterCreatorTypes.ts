...
interface ClassToolProficiency {
  fixed: string[];
...
export interface RaceDetail {
  ...
  traits: { name: string; text: string; category: string | null; modifier: string[]; scalingRolls?: Array<{ description: string | null; level: number | null; formula: string }>; preparedSpellProgression?: PreparedSpellProgressionTable[]; effects?: unknown[]; hidden?: boolean }[];
}
