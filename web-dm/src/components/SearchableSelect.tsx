...
/** A "<Label>: All / Add…" filter chip picker — the multi-select sibling of SearchableSelect.
 * Choosing an option calls `onAdd`; the caller owns the selected-values array and renders it
 * as removable chips elsewhere (already-selected options are excluded from the dropdown). */
