    ...
    <div style={{ display: "flex", gap: 7, flexWrap: "wrap" }}>
      {rows.map((row) => (
        <button
          ...
          style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "5px 8px", border: `1px solid ${theme.colors.panelBorder}`, borderRadius: 7, background: "rgba(255,255,255,.055)", color: theme.colors.text, cursor: "pointer", font: "inherit" }}
        >
          <b>{row.name}</b>
