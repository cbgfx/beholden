  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 8, color: theme.colors.green, fontWeight: 900 }}>
        ...
        Valid Beholden v2 file — ready to import
      </div>
...
export function XmlConversionActions(props: {
  ...
  return (
    <div style={{ marginTop: 14, display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
      ...
      />
      <Button onClick={props.onConvert} disabled={!props.fileSelected || props.busy}>
        {props.busy ? "Working..." : "Convert XML to Beholden JSON"}
      </Button>
    </div>
  );
}
