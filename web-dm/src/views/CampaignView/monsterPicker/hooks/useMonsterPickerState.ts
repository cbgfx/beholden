...
export function useMonsterPickerState(args: {
  ...
  const { rulesetFilter, setRulesetFilter, showRulesetFilter } = useAvailableRulesets(api, "monsters", isOpen);
  ...
  }, [isOpen, compQ, sortMode, envFilter, sizeFilter, typeFilter, crMin, crMax, rulesetFilter]);
