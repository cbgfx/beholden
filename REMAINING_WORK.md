...
2. Structure remaining base-class choices and mechanics, including genuine spell and talent replacement and other progression choices not yet represented. Free-form details such as the two specific humanoid peoples selected by Favored Enemy remain player-entered notes.
